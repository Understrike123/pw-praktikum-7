function ubah(){
    ...
    if(provinsi=="aceh"){
        ...
        option[0].getElementsByTagName('option')[1].innerHTML="Kabupaten Aceh Barat";
        option[0].getElementsByTagName('option')[1].value="aceh_barat";
        option[0].getElementsByTagName('option')[2].innerHTML="Kabupaten Aceh Besar";
        option[0].getElementsByTagName('option')[2].value="aceh_barat";
        option[0].getElementsByTagName('option')[3].innerHTML="Kabupaten Aceh Jaya";
        option[0].getElementsByTagName('option')[3].value="aceh_jaya";
        option[0].getElementsByTagName('option')[4].innerHTML="Kabupaten Aceh Selatan";
        option[0].getElementsByTagName('option')[4].value="aceh_selatan";
        option[0].getElementsByTagName('option')[5].innerHTML="Kabupaten Aceh Singkil";
        option[0].getElementsByTagName('option')[5].value="aceh_singkil";
